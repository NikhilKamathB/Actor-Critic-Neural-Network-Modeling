...
if __name__ == "__main__":
    ...
    actor = Actor(train_data_file_name=train_data_file_name, train_label_file_name=train_label_file_name, test_data_file_name=test_data_file_name, test_label_file_name=test_label_file_name)
    actor.run()